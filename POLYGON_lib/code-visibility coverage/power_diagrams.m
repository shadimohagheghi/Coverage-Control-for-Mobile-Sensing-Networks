function vor=power_diagrams(x,y,x1,y1,N,r)
vor={};...
...
%             vor{j2,2}=y1;...
            ...
            if b~=0
                 ...
                 %h diagwnios tou.
                if -b/a>0
                     box1=[minx-10,yl1;minx-10,miny-10;maxx+10 miny-10;maxx+10,yl2];
                     box2=[minx-10,maxy+10;maxx+10,maxy+10;maxx+10,yl2;minx-10,yl1];
                else
                     box1=[minx-10,yl1;minx-10,miny-10;maxx+10 miny-10;maxx+10,yl2];
                     box2=[minx-10,maxy+10;maxx+10,maxy+10;maxx+10,yl2;minx-10,yl1];
                end
