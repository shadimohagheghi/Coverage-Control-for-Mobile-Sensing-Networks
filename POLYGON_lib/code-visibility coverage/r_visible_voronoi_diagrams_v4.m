function [vor,r_lim]=r_visible_voronoi_diagrams_v4(x,y,x1,y1,r,N)
...
%        area2=polyarea(xvpol,yvpol);
        ...
        plot(xv,yv,'yellow')
         ...
         for j2=1:length(del)
           ...
           [fx2,fy2]=find_common_edge_v2(xv,yv,tx2,ty2);... %vrsikw to koino edge  (twn klassikwn voronoi)    
...
%            end
           ...
           if length(fx6)<=0 %einai eite plhrws orato eite plhrws aorato
             ...
             %   in=inpolygon(fx2(1),fy2(1),x_pol2,y_pol2);%ALLAGH  ..UPARXOUN ARITHMITIKA SFALMATA  p_poly_dist
                [d1,x_poly,y_poly] = p_poly_dist(fx2(1), fy2(1), x_pol2, y_pol2) ;
                [d2,x_poly,y_poly] = p_poly_dist(fx2(2), fy2(2), x_pol2, y_pol2) ;
                if abs(d1)<10^(-8)
