function vor=visibility_power_diagrams(x,y,x1,y1,N,r)
vor={};...
...
for j1=1:N
   ...
   [x_vp1,y_vp1]=visible_polygon_v2(x,y,x1,y1,j1);%visibility_polygon-node j1

    vor{j1,1}=x_vp1;...
    vor{j1,2}=y_vp1;...
    xtemp=x_vp1;ytemp=y_vp1;
    for j2=1:N
      if j2~=j1
...
%             [vorx2,vory2]=polybool('intersection',box2(:,1),box2(:,2),x1,y1);...
            ...
            [temp_vorx1,temp_vory1]=polybool('intersection',not_box(:,1),not_box(:,2),xtemp,ytemp); 
