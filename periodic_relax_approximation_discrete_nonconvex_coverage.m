function agent_locations = periodic_relax_approximation_discrete_nonconvex_coverage(numIteration, showPlot, num_agents, obstacles,seed, relax_ratio)
close all
...
for counter = 1:numIteration
    ...
    %If we are in an exploit regime
    if counter
